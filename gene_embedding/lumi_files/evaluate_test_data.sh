...
## Run the stuff
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $test_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $vfluvialis_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $spneumoniae_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $efaecalis_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $ehirae_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $edurans_set
python evaluate_model_and_dataset.py --model_path $modelpath --dataset-path $eavium_set
