...
class GeneTransformer(models.Model):
    ...
    def _align_data_to_devices(self, data:tf.data.Dataset, batch_size:int, verbose:bool=True):
    ...
    def train(self, 
        ...
        _validation = _validation.batch(_validation_batch, drop_remainder=True).cache()
