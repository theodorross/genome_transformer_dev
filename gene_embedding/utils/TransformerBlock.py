...
class TransformerDecoderBlock(layers.Layer):
    ...
    def __init__(self, output_dim:int, 
        ...
        ## Attention layer
        self.attn = layers.MultiHeadAttention(num_heads=self.num_heads, key_dim=self.key_dim, dropout=self.dropout_rate, output_shape=(self.output_dim,))
...
class TransformerEncoderBlock(layers.Layer):
    ...
    def __init__(self, output_dim:int, 
        ...
        ## Attention layer
        self.cross_attn = layers.MultiHeadAttention(num_heads=num_heads, key_dim=key_dim, dropout=dropout_rate, output_shape=(self.output_dim,))
        self.self_attn = layers.MultiHeadAttention(num_heads=num_heads, key_dim=key_dim, dropout=dropout_rate, output_shape=(self.output_dim,))
